...
void RenderGSUTestFunctions()
{
    ...
    static int placeholderValue = 0; // Define a placeholder value (e.g., for valve position)

    // Create a slider for user input
    ImGui::SliderInt("Valve Position", &placeholderValue, 0, 100);
    // Button for sending the command
    if (ImGui::Button("Burner Valve Test")) {
        // Format the serial command with the placeholder value
        std::string command = "BURNER_VALVE " + std::to_string(placeholderValue);
        SendSerialCommand(command);
        
    }

    if (ImGui::Button("Smoke Valve Test")) {
        // Format the serial command with the placeholder value
        std::string command = "BURNER_VALVE " + std::to_string(placeholderValue);
        SendSerialCommand(command);
    ...
    if (ImGui::Button("Fuel Valve Test")) {
        // Format the serial command with the placeholder value
        std::string command = "BURNER_VALVE " + std::to_string(placeholderValue);
        SendSerialCommand(command);
    ...
    if (ImGui::Button("Purge Valve Test")) {
        // Format the serial command with the placeholder value
        std::string command = "BURNER_VALVE " + std::to_string(placeholderValue);
        SendSerialCommand(command);
    ...
    if (ImGui::Button("End Turbine Spool")) {
        // Format the serial command with the placeholder value
        std::string command = "BURNER_VALVE " + std::to_string(placeholderValue);
        SendSerialCommand(command);
    ...
    if (ImGui::Button("Starter Motor Test")) {
        // Format the serial command with the placeholder value
        std::string command = "BURNER_VALVE " + std::to_string(placeholderValue);
        SendSerialCommand(command);
